...
class SVideoFilePostVariant(
    private val root: Path<VideoFilePostVariant>,
    ...
    companion object {
        ...
        @JvmStatic
        fun specify(builder: PredicateBuilder<SVideoFilePostVariant>): Specification<VideoFilePostVariant> {
            return specify(builder, false, emptyList())
        }

        @JvmStatic
        fun specify(builder: PredicateBuilder<SVideoFilePostVariant>, distinct: Boolean): Specification<VideoFilePostVariant> {
            return specify(builder, distinct, emptyList())
        }

        @JvmStatic
        fun specify(
            builder: PredicateBuilder<SVideoFilePostVariant>,
            vararg orderBuilders: OrderBuilder<SVideoFilePostVariant>,
        ): Specification<VideoFilePostVariant> {
        ...
        fun specify(
            builder: PredicateBuilder<SVideoFilePostVariant>,
            orderBuilders: List<OrderBuilder<SVideoFilePostVariant>>,
        ): Specification<VideoFilePostVariant> {
        ...
        @JvmStatic
        fun specify(specifier: SchemaSpecification<VideoFilePostVariant, SVideoFilePostVariant>): Specification<VideoFilePostVariant> {
            return Specification { root, criteriaQuery, criteriaBuilder ->
                val schema = SVideoFilePostVariant(root, criteriaBuilder)
        ...
        fun <E> subquery(
            resultClass: Class<E>,
            selectBuilder: ExpressionBuilder<SVideoFilePostVariant, E>,
            predicateBuilder: PredicateBuilder<SVideoFilePostVariant>,
        ...
        fun <E> subquery(
            resultClass: Class<E>,
            subqueryConfigure: SubqueryConfigure<E, SVideoFilePostVariant>,
            criteriaBuilder: CriteriaBuilder,
            criteriaQuery: CriteriaQuery<*>,
        ): Subquery<E> {
            val sq = criteriaQuery.subquery(resultClass)
            val root = sq.from(VideoFilePostVariant::class.java)
            val schema = SVideoFilePostVariant(root, criteriaBuilder)
    ...
    fun _root(): Path<VideoFilePostVariant> = root
    ...
    fun spec(builder: PredicateBuilder<SVideoFilePostVariant>): Predicate {
