...
@TranslationType(type = "user_login_log_login_type_code_to_desc")
@Component
class LoginTypeTranslation : TranslationInterface<String>, BatchTranslationInterface<String> {

    companion object {
        const val USER_LOGIN_LOG_LOGIN_TYPE_CODE_TO_DESC = "user_login_log_login_type_code_to_desc"
    }
    ...
    override fun translation(key: Any, other: String): String? {
        ...
        return LoginType.valueOfOrNull(code)?.description
    }
