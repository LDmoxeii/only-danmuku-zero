...
@TranslationType(type = "customer_profile_sex_type_code_to_desc")
@Component
class SexTypeTranslation : TranslationInterface<String>, BatchTranslationInterface<String> {

    companion object {
        const val CUSTOMER_PROFILE_SEX_TYPE_CODE_TO_DESC = "customer_profile_sex_type_code_to_desc"
    }
    ...
    override fun translation(key: Any, other: String): String? {
        ...
        return SexType.valueOfOrNull(code)?.description
    }
