...
@TranslationType(type = "video_post_video_status_code_to_desc")
@Component
class VideoStatusTranslation : TranslationInterface<String>, BatchTranslationInterface<String> {

    companion object {
        const val VIDEO_POST_VIDEO_STATUS_CODE_TO_DESC = "video_post_video_status_code_to_desc"
    }
    ...
    override fun translation(key: Any, other: String): String? {
        ...
        return VideoStatus.valueOfOrNull(code)?.description
    }
